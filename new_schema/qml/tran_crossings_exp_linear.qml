...
<qgis simplifyLocal="1" version="3.0.0-Girona" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" maxScale="0" readOnly="0" minScale="0" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyDrawingHints="1" simplifyDrawingTol="1">
  <renderer-v2 type="RuleRenderer" forceraster="0" enableorderby="0" symbollevels="0">
    <rules key="{755189ae-55b4-450e-aa40-3bf0e7e38fb9}">
      <rule filter="&quot;feat_type&quot; = 'Any Other Bridge'" scalemindenom="1000" scalemaxdenom="15000" key="{f6afb8bc-5dbc-4607-94e3-0f2472a61823}" label="Any Other Bridge" symbol="0"/>
      <rule filter="&quot;feat_type&quot; = 'Any Other Tunnel'" key="{64631688-4561-4add-add9-5f5bfc8f6eef}" label="Any Other Tunnel" symbol="1"/>
      <rule filter="&quot;feat_type&quot; = 'Lowlevel Bridge'" key="{10f149d8-7f8b-49ce-aa6a-644eebfbdf9a}" label="Lowlevel Bridge" symbol="2"/>
      <rule filter="&quot;feat_type&quot; = 'Pedestrian Bridge'" key="{a65e74bd-af2c-46d8-bad4-def4f3511285}" label="Pedestrian Bridge" symbol="3"/>
      <rule filter="&quot;feat_type&quot; = 'Rail Bridge'" key="{7a4413dc-41c2-473a-9456-ded9ec81efa8}" label="Rail Bridge" symbol="4"/>
      <rule filter="&quot;feat_type&quot; = 'Rail Tunnel'" key="{fb6fdbe1-1680-4e8a-8c30-c427710f31a6}" label="Rail Tunnel" symbol="5"/>
      <rule filter="&quot;feat_type&quot; = 'Road Bridge'" key="{7ab5f10f-ec02-43e9-bd03-64ddc010c4fb}" label="Road Bridge" symbol="6"/>
      <rule filter="&quot;feat_type&quot; = 'Road Tunnel'" key="{4410a028-ce49-47ae-bd66-51823c2aee59}" label="Road Tunnel" symbol="7"/>
      <rule filter="&quot;feat_type&quot; = 'Tunnel Entrance'" key="{57e6a112-0a1c-4acc-9055-412a5544bfd8}" label="Tunnel Entrance" symbol="8"/>
    </rules>
    <symbols>
      ...
      <symbol type="line" clip_to_extent="1" alpha="1" name="1">
        <layer enabled="1" locked="0" pass="0" class="SimpleLine">
          ...
          <prop v="bevel" k="joinstyle"/>
          <prop v="217,110,218,255" k="line_color"/>
      ...
      <symbol type="line" clip_to_extent="1" alpha="1" name="2">
        <layer enabled="1" locked="0" pass="0" class="SimpleLine">
          ...
          <prop v="0" k="draw_inside_polygon"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="217,196,121,255" k="line_color"/>
          <prop v="solid" k="line_style"/>
          <prop v="0.26" k="line_width"/>
          <prop v="MM" k="line_width_unit"/>
          <prop v="0" k="offset"/>
      ...
      <symbol type="line" clip_to_extent="1" alpha="1" name="3">
        <layer enabled="1" locked="0" pass="0" class="SimpleLine">
          ...
          <prop v="0" k="draw_inside_polygon"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="117,211,170,255" k="line_color"/>
          <prop v="solid" k="line_style"/>
          <prop v="0.26" k="line_width"/>
          <prop v="MM" k="line_width_unit"/>
          <prop v="0" k="offset"/>
      ...
      <symbol type="line" clip_to_extent="1" alpha="1" name="4">
        <layer enabled="1" locked="0" pass="0" class="SimpleLine">
          ...
          <prop v="0" k="draw_inside_polygon"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="124,56,232,255" k="line_color"/>
          <prop v="solid" k="line_style"/>
          <prop v="0.26" k="line_width"/>
          <prop v="MM" k="line_width_unit"/>
          <prop v="0" k="offset"/>
      ...
      <symbol type="line" clip_to_extent="1" alpha="1" name="5">
        <layer enabled="1" locked="0" pass="0" class="SimpleLine">
          ...
          <prop v="0" k="draw_inside_polygon"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="170,227,72,255" k="line_color"/>
          <prop v="solid" k="line_style"/>
          <prop v="0.26" k="line_width"/>
          <prop v="MM" k="line_width_unit"/>
          <prop v="0" k="offset"/>
      ...
      <symbol type="line" clip_to_extent="1" alpha="1" name="6">
        <layer enabled="1" locked="0" pass="0" class="SimpleLine">
          ...
          <prop v="0" k="draw_inside_polygon"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="89,114,204,255" k="line_color"/>
          <prop v="solid" k="line_style"/>
          <prop v="0.26" k="line_width"/>
          <prop v="MM" k="line_width_unit"/>
          <prop v="0" k="offset"/>
      ...
      <symbol type="line" clip_to_extent="1" alpha="1" name="7">
        <layer enabled="1" locked="0" pass="0" class="SimpleLine">
          ...
          <prop v="0" k="draw_inside_polygon"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="118,212,230,255" k="line_color"/>
          <prop v="solid" k="line_style"/>
          <prop v="0.26" k="line_width"/>
          <prop v="MM" k="line_width_unit"/>
          <prop v="0" k="offset"/>
      ...
      <symbol type="line" clip_to_extent="1" alpha="1" name="8">
        <layer enabled="1" locked="0" pass="0" class="SimpleLine">
          ...
          <prop v="0" k="draw_inside_polygon"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="46,210,41,255" k="line_color"/>
          <prop v="solid" k="line_style"/>
          <prop v="0.26" k="line_width"/>
          <prop v="MM" k="line_width_unit"/>
          <prop v="0" k="offset"/>
