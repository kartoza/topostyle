...
<qgis version="2.18.16" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{2c62f0c5-0a0d-40bf-b9d2-5aa8337d9ead}">
      <rule scalemaxdenom="80000" filter="&quot;feat_type&quot; = 'Tunnel Entrance'" key="{6ad485fb-0c33-4db6-8eda-eb529b40c25d}" symbol="0" scalemindenom="1" label="Tunnel Entrance"/>
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="op_status" index="5" name=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="-1922797440">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="op_status"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="op_status" expression=""/>
