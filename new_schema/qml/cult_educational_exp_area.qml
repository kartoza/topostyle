...
<qgis version="2.8.1-Wien" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="edu_level">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="gender">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{1641557a-299c-491e-858c-f3c7f6ca6adf}">
      <rule scalemaxdenom="80000" filter="feat_type = 'College'" key="{1f23ffe9-b672-45be-9946-74789eb3ab2b}" symbol="0" scalemindenom="1" label="College"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'School'" key="{8c0cf249-f5fe-4a65-8f46-b2f834c66ac1}" symbol="1" scalemindenom="1" label="School"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'University'" key="{cadcee55-3301-4541-8f17-4a321d2d7478}" symbol="2" scalemindenom="1" label="University"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'University of Technology'" key="{c20ae32b-cc89-4634-9efb-ecbbcf8636f9}" symbol="3" scalemindenom="1" label="University of Technology"/>
    </rules>
    <symbols>
