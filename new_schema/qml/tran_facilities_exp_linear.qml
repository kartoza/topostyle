...
<qgis simplifyLocal="1" maxScale="0" labelsEnabled="1" readOnly="0" simplifyDrawingTol="1" minScale="0" simplifyAlgorithm="0" simplifyDrawingHints="1" simplifyMaxScale="1" version="2.99.0-Master" hasScaleBasedVisibilityFlag="0">
  <renderer-v2 symbollevels="0" forceraster="0" enableorderby="0" type="RuleRenderer">
    <rules key="{89102e92-b0d9-4489-a902-e9525b08f758}">
      <rule filter="&quot;feat_type&quot; = 'Harbour'" symbol="0" label="Harbour" key="{9a250125-c749-4fbb-b6d4-3c3117cdc092}"/>
      <rule filter="&quot;feat_type&quot; = 'Jetty' or &quot;feat_type&quot; = 'Pier'" symbol="1" label="Jetty and Pier" key="{40b28ab1-9ece-49f4-8bea-aabee2ad6879}"/>
      <rule filter="&quot;feat_type&quot; = 'Landing Strip'" symbol="2" label="Landing Strip" key="{0d16dbcc-50fa-4fb8-9f8c-890ecc8313b9}"/>
      <rule filter="&quot;feat_type&quot; = 'Railway Station'" symbol="3" label="Railway Station" key="{bb7f25c7-5f53-4676-80a3-b5dce05a6494}"/>
      <rule filter="&quot;feat_type&quot; = 'Toll Gate'" symbol="4" label="Toll Gate" key="{fad1439a-5ffc-4b77-b8b7-43c837cbbd67}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{c23ffd80-309f-4ab7-9ce4-3961b3b78bd7}">
      <rule filter=" &quot;feat_type&quot;  =  'Harbour' " key="{46657420-fc7f-49d9-947c-6dada5fc490a}" description="Harbour">
        <settings>
          <text-style fontWeight="50" previewBkgrdColor="#ffffff" multilineHeight="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontUnderline="0" textColor="0,0,0,255" fontSize="7" useSubstitutions="0" fontStrikeout="0" fontSizeUnit="Point" fieldName="CASE WHEN    &quot;entity_name&quot;  ~ '^[0-9]+$'  THEN NULL&#xa;&#xa;else   &quot;entity_name&quot;   END" fontItalic="0" fontCapitals="0" isExpression="1" blendMode="0" namedStyle="Regular" fontFamily="Ubuntu" textOpacity="1" fontLetterSpacing="0" fontWordSpacing="0">
          ...
          <placement placement="2" xOffset="0" priority="5" centroidWhole="0" offsetType="0" rotationAngle="0" repeatDistance="0" repeatDistanceUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" distUnits="MM" yOffset="0" preserveRotation="1" maxCurvedCharAngleOut="-25" placementFlags="10" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MM" dist="0" quadOffset="4" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" fitInPolygonOnly="0" maxCurvedCharAngleIn="25"/>
      ...
      <rule filter=" &quot;feat_type&quot;  =  'Landing Strip' " key="{53ec33eb-74af-4495-b573-7c39a7f0366e}" description="Landing Sprip">
        <settings>
          <text-style fontWeight="50" previewBkgrdColor="#ffffff" multilineHeight="1" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontUnderline="0" textColor="0,0,0,255" fontSize="7" useSubstitutions="0" fontStrikeout="0" fontSizeUnit="Point" fieldName="CASE WHEN    &quot;entity_name&quot;  ~ '^[0-9]+$'  THEN NULL&#xa;&#xa;else   &quot;entity_name&quot;   END" fontItalic="0" fontCapitals="0" isExpression="1" blendMode="0" namedStyle="Regular" fontFamily="Ubuntu" textOpacity="1" fontLetterSpacing="0" fontWordSpacing="0">
            <text-buffer bufferOpacity="1" bufferDraw="0" bufferNoFill="1" bufferColor="255,255,255,255" bufferBlendMode="0" bufferSize="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="MM" bufferJoinStyle="128"/>
            <background shapeRotationType="0" shapeSizeType="0" shapeBlendMode="0" shapeJoinStyle="64" shapeOffsetY="0" shapeSizeY="0" shapeRadiiY="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeRotation="0" shapeFillColor="255,255,255,255" shapeSVGFile="" shapeSizeX="0" shapeOpacity="1" shapeOffsetUnit="MM" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidthUnit="MM" shapeType="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeUnit="MM" shapeRadiiUnit="MM" shapeBorderColor="128,128,128,255" shapeOffsetX="0" shapeBorderWidth="0" shapeRadiiX="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeDraw="0"/>
