...
<qgis simplifyLocal="1" maxScale="0" labelsEnabled="1" readOnly="0" simplifyDrawingTol="1" minScale="0" simplifyAlgorithm="0" simplifyDrawingHints="1" simplifyMaxScale="1" version="2.99.0-Master" hasScaleBasedVisibilityFlag="0">
  <renderer-v2 symbollevels="0" forceraster="0" enableorderby="0" type="RuleRenderer">
    <rules key="{5d8e93a0-1391-4697-9a3a-d9bef588bd40}">
      <rule filter="&quot;feat_type&quot; = 'Hiking Trail'" symbol="0" label="Hiking Trail" key="{0462ddfe-b8c2-41c6-a132-7277bbc091e4}"/>
      <rule filter="&quot;feat_type&quot; in ( 'Horse-race course' , 'Race Route','Scale Model Facility')" symbol="1" label="Horse-race course" key="{54c909e3-a88e-4af2-aeb5-d69d7f26745d}"/>
      <rule filter="&quot;feat_type&quot; = 'Motor sport track'" symbol="2" label="Motor sport track" key="{0b9405b0-945f-48b3-9138-0931f9845980}"/>
      <rule filter="&quot;feat_type&quot; = 'Shooting Range'" symbol="3" label="Shooting Range" key="{ffd16aa0-1eab-4f94-8c90-787c55d19de4}"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{55c2f4f8-bbfa-406c-b591-7d24194d1e4e}">
      <rule filter=" &quot;feat_type&quot; in ( 'Horse-race course', 'Motor sport track' ) " key="{367e1d4d-03f5-4745-9b91-596298a511c7}" description="Horse-race Course">
        <settings>
