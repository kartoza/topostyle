...
<qgis simplifyLocal="1" version="3.0.0-Girona" hasScaleBasedVisibilityFlag="0" labelsEnabled="1" maxScale="0" readOnly="0" minScale="1e+8" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyDrawingHints="0" simplifyDrawingTol="1">
  <renderer-v2 type="RuleRenderer" forceraster="0" enableorderby="0" symbollevels="0">
    <rules key="{dc8dd416-e06c-4e61-85ed-5573a97100f1}">
      <rule filter="&quot;feat_type&quot; = 'Any Other Reservoir'" scalemindenom="1" scalemaxdenom="80000" key="{0d891583-6943-4286-b107-869729165354}" label="Any Other Reservoir" symbol="0"/>
      <rule filter="&quot;feat_type&quot; = 'Factory'" scalemindenom="1" scalemaxdenom="80000" key="{d3e551f6-b8df-4816-9265-80ba5d5c0175}" label="Factory" symbol="1"/>
      <rule filter="&quot;feat_type&quot; = 'Fuel StorageTank'" scalemindenom="1" scalemaxdenom="80000" key="{d41d6410-ff33-49ce-a64c-d8cf95788c0d}" label="Fuel StorageTank" symbol="2"/>
      <rule filter="&quot;feat_type&quot; = 'Sawmill'" scalemindenom="1" scalemaxdenom="80000" key="{2656b866-69dd-4977-a766-67ad38f6b039}" label="Sawmill" symbol="3"/>
      <rule filter="&quot;feat_type&quot; = 'Silo'" scalemindenom="1" scalemaxdenom="80000" key="{3bf136ce-907d-4e2c-8546-7dad77d0402d}" label="Silo" symbol="4"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{a3b783a0-6c93-4151-b408-ee43035e72f7}">
      <rule filter="&quot;feat_type&quot; in ('LOOK OUT TOWER', 'MINE SHAFT', 'SILO', 'STATION') " key="{f4bec3ac-af99-4bf1-9b95-0da8acdd78cc}" description="Label">
        <settings>
          <text-style fontLetterSpacing="0" previewBkgrdColor="#ffffff" fontCapitals="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontWordSpacing="0" fontItalic="1" fontSizeUnit="Point" fontUnderline="0" isExpression="0" textOpacity="1" useSubstitutions="0" multilineHeight="1" fieldName="feat_type" fontWeight="75" fontFamily="Ubuntu" blendMode="0" fontStrikeout="0" fontSize="6" textColor="0,0,0,255" namedStyle="Bold Italic">
            <text-buffer bufferNoFill="0" bufferJoinStyle="64" bufferSize="0.1" bufferBlendMode="0" bufferOpacity="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="255,255,255,255" bufferDraw="1" bufferSizeUnits="MM"/>
          ...
          <placement maxCurvedCharAngleOut="-20" rotationAngle="0" placementFlags="0" dist="0.4" repeatDistance="0" distMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" xOffset="0" centroidWhole="0" fitInPolygonOnly="0" maxCurvedCharAngleIn="20" offsetType="0" placement="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" preserveRotation="1" quadOffset="4" priority="5" yOffset="0" offsetUnits="MapUnit" centroidInside="0" distUnits="MM"/>
