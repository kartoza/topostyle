...
<qgis version="2.18.16" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="ref_50k">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="ref_10k">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="pipe_type">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{dc8dd416-e06c-4e61-85ed-5573a97100f1}">
      <rule scalemaxdenom="80000" filter="&quot;feat_type&quot; = 'Any Other Reservoir'" key="{0d891583-6943-4286-b107-869729165354}" symbol="0" scalemindenom="1" label="Any Other Reservoir"/>
      <rule scalemaxdenom="80000" filter="&quot;feat_type&quot; = 'Factory'" key="{d3e551f6-b8df-4816-9265-80ba5d5c0175}" symbol="1" scalemindenom="1" label="Factory"/>
      <rule scalemaxdenom="80000" filter="&quot;feat_type&quot; = 'Fuel StorageTank'" key="{d41d6410-ff33-49ce-a64c-d8cf95788c0d}" symbol="2" scalemindenom="1" label="Fuel StorageTank"/>
      <rule scalemaxdenom="80000" filter="&quot;feat_type&quot; = 'Sawmill'" key="{2656b866-69dd-4977-a766-67ad38f6b039}" symbol="3" scalemindenom="1" label="Sawmill"/>
      <rule scalemaxdenom="80000" filter="&quot;feat_type&quot; = 'Silo'" key="{3bf136ce-907d-4e2c-8546-7dad77d0402d}" symbol="4" scalemindenom="1" label="Silo"/>
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="ref_50k" index="20" name=""/>
    <alias field="ref_10k" index="21" name=""/>
    <alias field="pipe_type" index="22" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="ref_50k"/>
      <column width="-1" hidden="0" type="field" name="ref_10k"/>
      <column width="-1" hidden="0" type="field" name="pipe_type"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="ref_50k" expression=""/>
    <default field="ref_10k" expression=""/>
    <default field="pipe_type" expression=""/>
  </defaults>
