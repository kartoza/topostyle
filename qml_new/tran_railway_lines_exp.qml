...
<qgis version="2.8.1-Wien" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{13d5f598-a74e-4477-8024-4aeefc299865}">
      <rule scalemaxdenom="80000" filter="FEAT_TYPE='Standard Gauge Railway Line'" key="{44f6493e-6b31-4f92-816a-8ab0fc7afda0}" symbol="0" scalemindenom="1000" label="Standard"/>
      <rule scalemaxdenom="80000" filter="FEAT_TYPE='Narrow Gauge Railway Line'" key="{68deb996-074f-4fec-98d7-7ce606053ce4}" symbol="1" scalemindenom="1000" label="Narrow Gauge"/>
      <rule scalemaxdenom="80000" filter="FEAT_TYPE='Railway Siding'" key="{fed3de7b-30ba-4814-8097-56c2b6742bf1}" symbol="2" scalemindenom="1000" label="Railway Siding"/>
      <rule scalemaxdenom="80000" filter="FEAT_TYPE='Other Railway Line' " key="{ec60513b-5e35-4f68-ae6c-d0568d197a10}" symbol="3" scalemindenom="1000" label="Other"/>
      <rule scalemaxdenom="80000" filter="FEAT_TYPE='Marshalling Yard'" key="{21cd99a9-f612-4371-843e-4c02c71d25c6}" symbol="4" scalemindenom="1000" label="Marshaling line"/>
    </rules>
    <symbols>
