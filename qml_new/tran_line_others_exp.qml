...
<qgis version="2.8.1-Wien" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{e17c4bd1-b6c9-446f-8b92-196eeaefef51}">
      <rule scalemaxdenom="80000" filter="feat_type = 'Dock'" key="{055f9fe5-2f7e-492f-8e79-4304eb144d3a}" symbol="0" scalemindenom="1" label="DOCK"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'Dry Dock'" key="{204633f5-df95-4c4d-9f22-eec1b660611a}" symbol="1" scalemindenom="1" label="DRY DOCK"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'Quay'" key="{37c37d08-8d24-4f17-9738-9ca74c5f288f}" symbol="2" scalemindenom="1" label="QUAY"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'Wharf'" key="{fb5e704f-9c22-41f3-81d9-519fbc4b1951}" symbol="3" scalemindenom="1" label="WHARF"/>
      <rule scalemaxdenom="80000" filter=" &quot;feat_type&quot;  =  'Cableway' " key="{ea093c6d-1031-4dcf-9761-71fd0516675f}" symbol="4" scalemindenom="1" label="Cableway"/>
    </rules>
    <symbols>
