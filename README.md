...
We at AfriSpatial have invested in getting the map and styles to the point where we feel confident to share them. We hope you find these useful. 
...
then look at 'map.png' in an image viewer.
