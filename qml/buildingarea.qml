...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="80000" filter="feat_type = 'BORDER CUSTOMS'" symbol="0" label="BORDER CUSTOMS"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'CLINIC'" symbol="1" label="CLINIC"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'CLUB HOUSE'" symbol="2" label="CLUB HOUSE"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'COLLEGE'" symbol="3" label="COLLEGE"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'FACTORY'" symbol="4" label="FACTORY"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'HOSPITAL'" symbol="5" label="HOSPITAL"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'HOTEL'" symbol="6" label="HOTEL"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'HOUSE'" symbol="7" label="HOUSE"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'LARGE BUILDING'" symbol="8" label="LARGE BUILDING"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'MARKET'" symbol="9" label="MARKET"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'MEDICAL SCHOOL'" symbol="10" label="MEDICAL SCHOOL"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'MISSION STATION'" symbol="11" label="MISSION STATION"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'PARLIAMENT'" symbol="12" label="PARLIAMENT"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'PLACE OF WORSHIP'" symbol="13" label="PLACE OF WORSHIP"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'PLACE OF WORSHIP POINT'" symbol="14" label="PLACE OF WORSHIP POINT"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'POLICE STATION'" symbol="15" label="POLICE STATION"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'POST OFFICE AREA'" symbol="16" label="POST OFFICE AREA"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'POWER STATION'" symbol="17" label="POWER STATION"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'PRISON'" symbol="18" label="PRISON"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'SAW MILL'" symbol="19" label="SAW MILL"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'SCHOOL'" symbol="20" label="SCHOOL"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'SCHOOL AREA'" symbol="21" label="SCHOOL AREA"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'SHOPPING CENTRE'" symbol="22" label="SHOPPING CENTRE"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'STORE SHOP'" symbol="23" label="STORE SHOP"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'STORE SHOP AREA'" symbol="24" label="STORE SHOP AREA"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'TECHNIKON'" symbol="25" label="TECHNIKON"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'UNIVERSITY'" symbol="26" label="UNIVERSITY"/>
    </rules>
    <symbols>
  ...
  <edittypes>
    <edittype labelontop="0" editable="1" type="0" name="____gid"/>
