...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      ...
      <rule scalemaxdenom="80000" filter="FEAT_TYPE='NARROW GAUGE'" symbol="1" label="Narrow Gauge"/>
      <rule scalemaxdenom="80000" filter="FEAT_TYPE='UNDER CONSTRUCTION'" symbol="2" label="Under construction"/>
      <rule scalemaxdenom="80000" filter="FEAT_TYPE='ABANDONED'" symbol="3" label="Abandoned"/>
      <rule scalemaxdenom="80000" filter="FEAT_TYPE='MARSHALING LINE'" symbol="4" label="Marshaling line"/>
      <rule scalemaxdenom="80000" filter="FEAT_TYPE IN ('STATION','LARGE STATION')" symbol="5" label="Station and large station"/>
    </rules>
    <symbols>
