...
<qgis version="1.8.0-Lisboa" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 attr="feat_type" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="LOOK OUT TOWER" label="LOOK OUT TOWER"/>
      <category symbol="1" value="SILO" label="SILO"/>
      <category symbol="2" value="TELECOM TOWER" label="TELECOM TOWER"/>
    </categories>
    <symbols>
    ...
    <source-symbol>
      <symbol outputUnit="MM" alpha="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="113,187,110,255"/>
          <prop k="color_border" v="0,0,0,255"/>
          <prop k="name" v="circle"/>
          <prop k="offset" v="0,0"/>
          <prop k="size" v="2"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="case when  &quot;feat_type&quot;  =  'TELECOM TOWER' then null&#xa;else  &quot;feat_type&quot; &#xa;end"/>
