...
<qgis version="1.8.0-Lisboa" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 attr="feat_type" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="HIGH URBAN DENSITY" label="HIGH URBAN DENSITY"/>
      <category symbol="1" value="LOW URBAN DENSITY" label="LOW URBAN DENSITY"/>
      <category symbol="2" value="TRACK OTHER" label="TRACK OTHER"/>
      <category symbol="3" value="RACE COURSE" label="RACE COURSE"/>
      <category symbol="4" value="RACING TRACK" label="RACING TRACK"/>
    </categories>
    <symbols>
