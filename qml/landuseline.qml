...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="80000" filter="feat_type = 'HIGH URBAN DENSITY'" symbol="0" label="HIGH URBAN DENSITY"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'LOW URBAN DENSITY'" symbol="1" label="LOW URBAN DENSITY"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'TRACK OTHER'" symbol="2" label="TRACK OTHER"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'RACE COURSE'" symbol="3" label="RACE COURSE"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'RACING TRACK'" symbol="4" label="RACING TRACK"/>
    </rules>
    <symbols>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="&#xa;case when  &quot;feat_type&quot; in( 'RACING TRACK', 'RACE COURSE')  then  &quot;feat_type&quot; &#xa;else NULL&#xa;END"/>
