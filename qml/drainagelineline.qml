...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="80000" filter="feat_type = 'AQUEDUCT'" symbol="0" label="AQUEDUCT"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'CANAL'" symbol="1" label="CANAL"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'FURROW'" symbol="2" label="FURROW"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'PIPELINE'" symbol="3" label="PIPELINE"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'SIPHON'" symbol="4" label="SIPHON"/>
    </rules>
    <symbols>
  ...
  <customproperties>
    ...
    <property key="labeling/textColorG" value="152"/>
