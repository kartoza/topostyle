...
<qgis version="1.8.0-Lisboa" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 attr="feat_type" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="AQUEDUCT" label="AQUEDUCT"/>
      <category symbol="1" value="CANAL" label="CANAL"/>
      <category symbol="2" value="FURROW" label="FURROW"/>
      <category symbol="3" value="PIPELINE" label="PIPELINE"/>
      <category symbol="4" value="SIPHON" label="SIPHON"/>
    </categories>
    <symbols>
