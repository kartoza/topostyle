...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="80000" filter="feat_type = 'CADASTRAL'" symbol="0" label="CADASTRAL"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'CONSERVATION'" symbol="1" label="CONSERVATION"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'INTERNATIONAL'" symbol="2" label="INTERNATIONAL"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'PROVINCIAL'" symbol="3" label="PROVINCIAL"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'STATE FOREST'" symbol="4" label="STATE FOREST"/>
    </rules>
    <symbols>
