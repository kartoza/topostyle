...
<qgis version="1.8.0-Lisboa" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule filter="feat_type = 'TRIGONOMETRIC BEACON'" symbol="0" label="TRIGONOMETRIC BEACON"/>
      <rule filter=" &quot;feat_type&quot;  =  'BENCH MARK' " symbol="1" label="Bench Mark"/>
      <rule filter=" &quot;feat_type&quot;  =  'BOUNDARY BEACON' " symbol="2" label="Boundary Beacon"/>
    </rules>
    <symbols>
  ...
  <customproperties>
    ...
    <property key="labeling/dist" value="0.8"/>
