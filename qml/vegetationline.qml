...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      ...
      <rule scalemaxdenom="80000" filter="feat_type = 'PLANTATION'" symbol="1" label="PLANTATION"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'TREE'" symbol="2" label="TREE"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'TREE LINE'" symbol="3" label="TREE LINE"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'WOODLAND'" symbol="4" label="WOODLAND"/>
    </rules>
    <symbols>
        ...
        <layer pass="0" class="MarkerLine" locked="0">
          ...
          <symbol alpha="1" type="marker" name="@2@0">
            <layer pass="0" class="SvgMarker" locked="0">
              ...
              <prop k="name" v="./svg_graphics/trees.svg"/>
              <prop k="offset" v="0,0"/>
              <prop k="offset_unit" v="MM"/>
      ...
      <symbol alpha="1" type="line" name="4">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="color" v="177,204,117,255"/>
          <prop k="customdash" v=""/>
          <prop k="customdash_unit" v="MM"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0"/>
