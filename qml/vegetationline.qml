...
<qgis version="1.8.0-Lisboa" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 attr="feat_type" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="CULTIVATED LAND" label="CULTIVATED LAND"/>
      <category symbol="1" value="PLANTATION" label="PLANTATION"/>
      <category symbol="2" value="TREE" label="TREE"/>
      <category symbol="3" value="TREE LINE" label="TREE LINE"/>
      <category symbol="4" value="WOODLAND" label="WOODLAND"/>
    </categories>
    <symbols>
