...
<qgis version="1.8.0-Lisboa" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 attr="feat_type" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="ISLAND" label="ISLAND"/>
      <category symbol="1" value="ISLAND IN DAM" label="ISLAND IN DAM"/>
      <category symbol="2" value="ISLAND IN WATER" label="ISLAND IN WATER"/>
      <category symbol="3" value="OPEN URBAN LAND" label="OPEN URBAN LAND"/>
    </categories>
    <symbols>
