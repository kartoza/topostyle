...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="80000" filter="feat_type = 'ISLAND'" symbol="0" label="ISLAND"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'ISLAND IN DAM'" symbol="1" label="ISLAND IN DAM"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'ISLAND IN WATER'" symbol="2" label="ISLAND IN WATER"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'OPEN URBAN LAND'" symbol="3" label="OPEN URBAN LAND"/>
    </rules>
    <symbols>
