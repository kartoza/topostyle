...
<qgis version="1.8.0-Lisboa" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 attr="feat_type" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="ANTI EROSION WALL" label="ANTI EROSION WALL"/>
      <category symbol="1" value="DAM WALL" label="DAM WALL"/>
      <category symbol="2" value="FENCE" label="FENCE"/>
      <category symbol="3" value="TRACK FOOTPATH" label="TRACK FOOTPATH"/>
      <category symbol="4" value="WALL" label="WALL"/>
      <category symbol="5" value="WEIR" label="WEIR"/>
    </categories>
    <symbols>
    ...
    <source-symbol>
      <symbol outputUnit="MM" alpha="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="color" v="214,145,219,255"/>
          <prop k="customdash" v="5;2"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0"/>
          <prop k="penstyle" v="solid"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="case when  &quot;feat_type&quot;  =  'WEIR' then  &quot;feat_type&quot; &#xa;else null&#xa;end"/>
