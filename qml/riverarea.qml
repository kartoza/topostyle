...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="80000" filter="feat_type = 'PERENNIAL EXTENT'" symbol="0" label="Non perennial extent"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'FLOOD BANK'" symbol="1" label="Flood bank"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'PERENNIAL EXTENT'" symbol="2" label="Perennial extent"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'NON-PERENNIAL CENTER LINE'" symbol="3" label="Non perenial center lines"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'PERENNIAL CENTER LINE'" symbol="4" label="Perennial centre line"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'SAND BANK'" symbol="5" label="Sand Bank"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'DRY WATER COURSE EXTENT'" symbol="6" label="Dry water course extent"/>
    </rules>
    <symbols>
