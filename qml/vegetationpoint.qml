...
<qgis version="2.1.0-Master" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="80000" filter=" &quot;feat_type&quot;  =  'TREE' " symbol="0" label="Tree"/>
      <rule scalemaxdenom="80000" filter=" &quot;feat_type&quot;  =  'CULTIVATED LAND' " symbol="1" label="Cultivated land"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" type="marker" name="1">
        <layer pass="0" class="SimpleMarker" locked="0">
          ...
          <prop k="color_border" v="39,119,64,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
