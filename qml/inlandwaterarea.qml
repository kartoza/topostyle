...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="80000" filter="feat_type = 'DAM'" symbol="0" label="DAM"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'DRY PAN'" symbol="1" label="DRY PAN"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'FISH FARM'" symbol="2" label="FISH FARM"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'LAKE'" symbol="3" label="LAKE"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'LARGE RESERVOIR'" symbol="4" label="LARGE RESERVOIR"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'MARSH VLEI'" symbol="5" label="MARSH VLEI"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'MUD FLATS'" symbol="6" label="MUD FLATS"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'NON-PERENNIAL PAN'" symbol="7" label="NON-PERENNIAL PAN"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'PERENNIAL PAN'" symbol="8" label="PERENNIAL PAN"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'POOL'" symbol="9" label="POOL"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'SCHOOL AREA'" symbol="10" label="SCHOOL AREA"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'SWAMP'" symbol="11" label="SWAMP"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'WATER TANK'" symbol="12" label="WATER TANK"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'PURIFICATION PLANT'" symbol="13" label="PURIFICATION PLANT"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'SEWERAGE WORKS'" symbol="14" label="SEWERAGE WORKS"/>
    </rules>
    <symbols>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="case when  &quot;feat_type&quot;  in ('PURIFICATION PLANT', 'SEWERAGE WORKS') then  &quot;feat_type&quot;   &#xa;else Null&#xa;end"/>
