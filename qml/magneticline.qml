...
<qgis version="2.0.1-Dufour" minimumScale="0" maximumScale="1e+08" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="80000" filter="feat_type = 'ANNUAL CHANGE'" symbol="0" label="ANNUAL CHANGE"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'ISOGONIC'" symbol="1" label="ISOGONIC"/>
    </rules>
    <symbols>
