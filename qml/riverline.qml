...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="80000" filter="feat_type = 'PERENNIAL CENTER LINE'" symbol="0" scalemindenom="1000" label="Perennial Centre line"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'DRY WATER COURSE CENTER LINE'" symbol="1" scalemindenom="1000" label="Dry water course center line"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'DRY WATER COURSE EXTENT'" symbol="2" scalemindenom="1000" label="Dry water course extent"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'NON-PERENNIAL CENTER LINE'" symbol="3" scalemindenom="1000" label="Non perennial centre line"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'RAPIDS'" symbol="4" scalemindenom="1000" label="Rapids"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'NON-PERENNIAL EXTENT'" symbol="5" scalemindenom="1000" label="Non perennial extent"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'WATERFALL'" symbol="6" scalemindenom="1000" label="Waterfall"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'PERENNIAL EXTENT'" symbol="7" scalemindenom="1000" label="Perennial extent"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'NON-PERENNIAL RIVER'" symbol="8" scalemindenom="1000" label="Non Perennial river"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'FLOOD BANK'" symbol="9" scalemindenom="1000" label="Flood bank"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" type="line" name="1">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="color" v="125,169,235,255"/>
  ...
  <edittypes>
    <edittype labelontop="0" editable="1" type="0" name="BY_"/>
    <edittype labelontop="0" editable="1" type="0" name="CAPTURE_IN"/>
    <edittype labelontop="0" editable="1" type="0" name="CONTRIBUTI"/>
    <edittype labelontop="0" editable="1" type="0" name="CREATE_DAT"/>
    <edittype labelontop="0" editable="1" type="0" name="DATA_SOURC"/>
    <edittype labelontop="0" editable="1" type="0" name="DATE0"/>
    <edittype labelontop="0" editable="1" type="0" name="DATE1"/>
    <edittype labelontop="0" editable="1" type="0" name="DATE2"/>
    <edittype labelontop="0" editable="1" type="0" name="DATE_"/>
    ...
    <edittype labelontop="0" editable="1" type="0" name="SOURCE__01"/>
    <edittype labelontop="0" editable="1" type="0" name="STATUS"/>
    <edittype labelontop="0" editable="1" type="0" name="TAG"/>
    <edittype labelontop="0" editable="1" type="0" name="TYPE_ID"/>
    <edittype labelontop="0" editable="1" type="0" name="VERSION_DA"/>
    <edittype labelontop="0" editable="1" type="0" name="VERSION_ID"/>
