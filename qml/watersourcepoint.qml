...
<qgis version="2.1.0-Master" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="80000" filter="feat_type = 'FOUNTAIN'" symbol="0" label="FOUNTAIN"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'HOT SPRING'" symbol="1" label="HOT SPRING"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'OTHER PUMP'" symbol="2" label="OTHER PUMP"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'RESERVOIR'" symbol="3" label="RESERVOIR"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'WATER TOWER'" symbol="4" label="WATER TOWER"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'WELL'" symbol="5" label="WELL"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'WINDPUMP'" symbol="6" label="WINDPUMP"/>
    </rules>
    <symbols>
