...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="80000" filter="feat_type = 'BIRD SANCTUARY'" symbol="0" label="BIRD SANCTUARY"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'BOTANICAL GARDEN'" symbol="1" label="BOTANICAL GARDEN"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'CARAVAN PARK'" symbol="2" label="CARAVAN PARK"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'CEMETERY'" symbol="3" label="CEMETERY"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'DRIVE IN THEATER'" symbol="4" label="DRIVE IN THEATER"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'GARDEN'" symbol="5" label="GARDEN"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'GOLF COURSE'" symbol="6" label="GOLF COURSE"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'HOLIDAY RESORT'" symbol="7" label="HOLIDAY RESORT"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'PARK'" symbol="8" label="PARK"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'REFUSE DUMP'" symbol="9" label="REFUSE DUMP"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'RIFLE RANGE'" symbol="10" label="RIFLE RANGE"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'ZOO'" symbol="11" label="ZOO"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'CONTAINER DEPOT'" symbol="12" label="CONTAINER DEPOT"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'GOLF DRIVING RANGE'" symbol="13" label="GOLF DRIVING RANGE"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'HIGH URBAN DENSITY'" symbol="14" label="HIGH URBAN DENSITY"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'LOW URBAN DENSITY'" symbol="15" label="LOW URBAN DENSITY"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'MILITARY CAMP'" symbol="16" label="MILITARY CAMP"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'RECREATION AREA'" symbol="17" label="RECREATION AREA"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" type="fill" name="3">
        <layer pass="0" class="SVGFill" locked="0">
          ...
          <prop k="svgFile" v="file:///home/admire/Documents/workingfiles/ngi/svg/cemetry.svg"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="case when  &quot;feat_type&quot; in ( 'CONTAINER DEPOT' , 'GOLF DRIVING RANGE' , 'HIGH URBAN DENSITY', 'LOW URBAN DENSITY', 'MILITARY CAMP') then  null  &#xa;          when  &quot;feat_type&quot;  =  'RECREATION AREA'  then  substr( &quot;feat_type&quot;,0,4)&#xa;else  &quot;feat_type&quot; &#xa;end"/>
