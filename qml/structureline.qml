...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="80000" filter="feat_type = 'TUNNEL ENTRANCE'" symbol="0" label="Tunnel Entrance"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'TUNNEL'" symbol="1" label="Tunnel"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'SLIPWAY'" symbol="2" label="Slipway"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'POWER LINE SINGLE'" symbol="3" label="Power line single"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'POWER LINE MULTIPLE'" symbol="4" label="Power line multiple"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'PIER'" symbol="5" label="Pier"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'DAM WALL'" symbol="6" label="Dam Wall"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'BRIDGE'" symbol="7" label="Bridge"/>
      <rule scalemaxdenom="80000" filter=" &quot;feat_type&quot;  =  'AERIAL CABLE WAY' " symbol="8" label="Aerial Cableway"/>
      <rule scalemaxdenom="80000" filter=" &quot;feat_type&quot;  =  'CONVEYOR BELT' " symbol="9" label="Conveyor belt"/>
    </rules>
    <symbols>
        ...
        <layer pass="0" class="MarkerLine" locked="0">
          ...
          <symbol alpha="1" type="marker" name="@0@0">
            ...
            <layer pass="0" class="FontMarker" locked="0">
              ...
              <prop k="color" v="0,0,0,255"/>
              <prop k="font" v="Dingbats"/>
              <prop k="offset" v="1.8,0.5"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="size" v="5.23333"/>
              <prop k="size_unit" v="MM"/>
            </layer>
            <layer pass="0" class="FontMarker" locked="0">
              <prop k="angle" v="0"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="case when  &quot;feat_type&quot; in ('AERIAL CABLE WAY', 'CONVEYOR BELT') then  &quot;feat_type&quot;  &#xa;else null&#xa;end "/>
