...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="80000" filter="feat_type = 'SHIPWRECK'" symbol="0" label="Shipwreck"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'GROUND SIGN'" symbol="1" label="Ground sign"/>
      <rule scalemaxdenom="80000" filter=" &quot;feat_type&quot;  =  'CAVE' " symbol="2" label="Cave"/>
      <rule scalemaxdenom="80000" filter=" &quot;feat_type&quot;  =  'BATTLEFIELD' " symbol="3" label="Battlefield"/>
      <rule scalemaxdenom="80000" filter=" &quot;feat_type&quot;  =  'MONUMENT' " symbol="4" label="Monument"/>
    </rules>
    <symbols>
