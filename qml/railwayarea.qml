...
<qgis version="1.8.0-Lisboa" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 attr="feat_type" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="LARGE STATION" label="LARGE STATION"/>
      <category symbol="1" value="STANDARD" label="STANDARD"/>
      <category symbol="2" value="STATION BUILDING" label="STATION BUILDING"/>
    </categories>
    <symbols>
