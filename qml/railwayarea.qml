...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="80000" filter="feat_type = 'LARGE STATION'" symbol="0" label="LARGE STATION"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'STANDARD'" symbol="1" label="STANDARD"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'STATION BUILDING'" symbol="2" label="STATION BUILDING"/>
    </rules>
    <symbols>
