...
<qgis version="1.8.0-Lisboa" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 attr="feat_type" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="BAY" label="BAY"/>
      <category symbol="1" value="BREAKWATER" label="BREAKWATER"/>
      <category symbol="2" value="CHANNEL" label="CHANNEL"/>
      <category symbol="3" value="COASTAL ROCK" label="COASTAL ROCK"/>
      <category symbol="4" value="COASTLINE" label="COASTLINE"/>
      <category symbol="5" value="DOCK" label="DOCK"/>
      <category symbol="6" value="DRY DOCK" label="DRY DOCK"/>
      <category symbol="7" value="HARBOUR" label="HARBOUR"/>
      <category symbol="8" value="QUAY" label="QUAY"/>
      <category symbol="9" value="WHARF" label="WHARF"/>
    </categories>
    <symbols>
