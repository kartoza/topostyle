...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="80000" filter="feat_type = 'AIRFIELD'" symbol="0" label="AIRFIELD"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'APRON'" symbol="1" label="APRON"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'HELIPAD'" symbol="2" label="HELIPAD"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'LANDING STRIP'" symbol="3" label="LANDING STRIP"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'RUNWAY'" symbol="4" label="RUNWAY"/>
      <rule scalemaxdenom="80000" filter=" &quot;feat_type&quot;  =  'AERODROME' " symbol="5" label="Aerodrome"/>
      <rule scalemaxdenom="80000" filter=" &quot;feat_type&quot;  =  'AIRPORT' " symbol="6" label="Airport"/>
    </rules>
    <symbols>
