...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="80000" filter=" &quot;feat_type&quot;  =  'MAGNETIC STATION' " symbol="0" label="Magnetic station"/>
    </rules>
    <symbols>
  ...
  <label>1</label>
  <labelfield>feat_type</labelfield>
  <labelattributes>
    <label fieldname="feat_type" text="Label"/>
    ...
    <x fieldname=""/>
    <y fieldname=""/>
    <offset x="10" y="0" units="pt" yfieldname="" xfieldname=""/>
