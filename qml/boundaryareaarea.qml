...
<qgis version="1.8.0-Lisboa" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 attr="feat_type" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="CADASTRAL" label="CADASTRAL"/>
      <category symbol="1" value="CONSERVATION" label="CONSERVATION"/>
      <category symbol="2" value="STATE FOREST" label="STATE FOREST"/>
    </categories>
    <symbols>
  ...
  <customproperties>
    ...
    <property key="labeling/textColorB" value="111"/>
    <property key="labeling/textColorG" value="166"/>
    <property key="labeling/textColorR" value="118"/>
