...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="80000" filter="feat_type = 'STATION'" symbol="0" label="Station"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'SILO'" symbol="1" label="Silo"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'MINE SHAFT'" symbol="2" label="Mine shaft"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'LOOK OUT TOWER'" symbol="3" label="Look out tower"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'TUNNEL ENTRANCE'" symbol="4" label="Tunnel entrance"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'TELECOM TOWER'" symbol="5" label="Telecom Tower"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'MICROWAVE TOWER'" symbol="6" label="Microwave tower"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'COOLING TOWER'" symbol="7" label="Cooling Tower"/>
    </rules>
    <symbols>
