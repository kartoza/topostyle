...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="80000" filter="feat_type = 'MINE SHAFT'" symbol="0" label="MINE SHAFT"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'SILO'" symbol="1" label="SILO"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'STADIUM'" symbol="2" label="STADIUM"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'STORAGE TANK'" symbol="3" label="STORAGE TANK"/>
      <rule scalemaxdenom="80000" filter="feat_type = 'TOLLGATE'" symbol="4" label="TOLLGATE"/>
    </rules>
    <symbols>
