...
<qgis version="1.8.0-Lisboa" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule filter="feat_type = 'MINE SHAFT'" symbol="0" label="MINE SHAFT"/>
      <rule filter="feat_type = 'SILO'" symbol="1" label="SILO"/>
      <rule filter="feat_type = 'STADIUM'" symbol="2" label="STADIUM"/>
      <rule filter="feat_type = 'STORAGE TANK'" symbol="3" label="STORAGE TANK"/>
      <rule filter="feat_type = 'TOLLGATE'" symbol="4" label="TOLLGATE"/>
    </rules>
    <symbols>
